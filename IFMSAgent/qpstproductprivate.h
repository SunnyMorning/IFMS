...
//    long pstIFMS1000MTPortNum;
    ...
    char pstIFMS1000MeasureEndToEndLossHighThreshold[NNN];
    size_t pstIFMS1000MeasureEndToEndLossHighThreshold_len;
    char old_pstIFMS1000MeasureEndToEndLossHighThreshold[NNN];
    size_t old_pstIFMS1000MeasureEndToEndLossHighThreshold_len;
    char pstIFMS1000MeasureEndToEndLossMiddleThreshold[NNN];
    size_t pstIFMS1000MeasureEndToEndLossMiddleThreshold_len;
    char old_pstIFMS1000MeasureEndToEndLossMiddleThreshold[NNN];
    size_t old_pstIFMS1000MeasureEndToEndLossMiddleThreshold_len;
    char pstIFMS1000MeasureEndToEndLossLowThreshold[NNN];
    size_t pstIFMS1000MeasureEndToEndLossLowThreshold_len;
    char old_pstIFMS1000MeasureEndToEndLossLowThreshold[NNN];
    size_t old_pstIFMS1000MeasureEndToEndLossLowThreshold_len;
...
public:
    ...
    QString get_pstIFMS1000MeasureEndToEndLossHighThreshold(quint16 channel);
    size_t get_pstIFMS1000MeasureEndToEndLossHighThreshold_len(quint16 channel);
    QString get_pstIFMS1000MeasureEndToEndLossMiddleThreshold(quint16 channel);
    size_t get_pstIFMS1000MeasureEndToEndLossMiddleThreshold_len(quint16 channel);
    QString get_pstIFMS1000MeasureEndToEndLossLowThreshold(quint16 channel);
    size_t get_pstIFMS1000MeasureEndToEndLossLowThreshold_len(quint16 channel);
    ...
    void  set_pstIFMS1000MeasureEndToEndLossHighThreshold(quint16 channel, QString s);
    void  set_pstIFMS1000MeasureEndToEndLossHighThreshold_len(quint16 channel, int s);
    void  set_pstIFMS1000MeasureEndToEndLossMiddleThreshold(quint16 channel, QString s);
    void  set_pstIFMS1000MeasureEndToEndLossMiddleThreshold_len(quint16 channel, int s);
    void  set_pstIFMS1000MeasureEndToEndLossLowThreshold(quint16 channel, QString s);
    void  set_pstIFMS1000MeasureEndToEndLossLowThreshold_len(quint16 channel, int s);
    ...
    long  get_pstIFMS1000PortLedStatus(int index);
    void  set_pstIFMS1000PortLedStatus(int index, int status);
signals:
