...
/* column number definitions for table pstIFMS1000MeasureTable */
       ...
       #define COLUMN_PSTIFMS1000MEASUREPULSEWIDTH		8
       #define COLUMN_PSTIFMS1000MEASURETIME		9
       #define COLUMN_PSTIFMS1000MEASUREPROGRESSSTATUS		10
       #define COLUMN_PSTIFMS1000MEASURETLOS		11
       #define COLUMN_PSTIFMS1000MEASURETREF		12
       #define COLUMN_PSTIFMS1000MEASUREFIBERLENGTHCHANGETHRESHOLD		13
       #define COLUMN_PSTIFMS1000MEASUREENDTOENDLOSSCRITICALTHRESHOLD		14
       #define COLUMN_PSTIFMS1000MEASUREENDTOENDLOSSMAJORTHRESHOLD		15
       #define COLUMN_PSTIFMS1000MEASUREENDTOENDLOSSMINORTHRESHOLD		16
       #define COLUMN_PSTIFMS1000MEASURENEWLOSSCRITICALTHRESHOLD		17
       #define COLUMN_PSTIFMS1000MEASURENEWLOSSMAJORTHRESHOLD		18
       #define COLUMN_PSTIFMS1000MEASURENEWLOSSMINORTHRESHOLD		19
       #define COLUMN_PSTIFMS1000MEASUREOLDLOSSCRITICALTHRESHOLD		20
       #define COLUMN_PSTIFMS1000MEASUREOLDLOSSMAJORTHRESHOLD		21
       #define COLUMN_PSTIFMS1000MEASUREOLDLOSSMINORTHRESHOLD		22
       #define COLUMN_PSTIFMS1000MEASURETEMPHIGHTHRESHOLD		23
       #define COLUMN_PSTIFMS1000MEASURETEMPLOWTHRESHOLD		24
       #define COLUMN_PSTIFMS1000MEASURENUMBER		25
       #define COLUMN_PSTIFMS1000MEASURENUMBERSORSTOREDEACHCHANNEL		26
